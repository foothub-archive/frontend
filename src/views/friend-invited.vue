...
import {
  ...
  LIST_A as LIST_A,
} from '../store/constants/friend-invited';
...
export default {
  ...
  computed: {
    results() {
      return this.$store.state.friendInvited.paginated.results;
    },
    current: {
      get() {
        return this.$store.state.friendInvited.paginated.current;
      },
      set(value) {
    ...
    count() {
      return this.$store.state.friendInvited.paginated.count;
    },
    pageSize() {
      return 14;
    },
    search: {
      get() {
        return this.$store.state.friendInvited.paginated.search;
      },
      set(value) {
